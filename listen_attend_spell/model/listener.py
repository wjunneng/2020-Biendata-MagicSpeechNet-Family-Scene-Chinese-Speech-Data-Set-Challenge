...
class PyramidalRNN(nn.Module):
    ...
    def __init__(self, rnn_cell, input_size, hidden_size, dropout_p):
        ...
        self.rnn = self.rnn_cell(input_size << 1, hidden_size, 2, bidirectional=True, batch_first=True,
                                 dropout=dropout_p)
...
class Listener(nn.Module):
    ...
    def __init__(self, feat_size, hidden_size, dropout_p=0.5, layer_size=5, bidirectional=True, rnn_cell='gru',
        ...
        if use_pyramidal:
            self.bottom_rnn = self.rnn_cell(feat_size, hidden_size, layer_size - 4, batch_first=True,
            ...
            self.rnn = self.rnn_cell(feat_size, hidden_size, layer_size, batch_first=True, bidirectional=bidirectional,
                                     dropout=dropout_p)
